...
class NotificationPlugin {
  ...
  // Determining what to display and detailed settings
  // Parameters
  // ----------
  // memoTitle : String
  //  word of displaying alarm screen
  // memoBody : String
  //  word of displaying alarm screen

  Future<void> showNotification(String memoTitle, String memoBody) async {
    var androidChannelSpecifics = AndroidNotificationDetails(
      'CHANNEL_ID',
      'CHANNEL_NAME',
      "CHANNEL_DESCRIPTION",
      // The importance of the notification.通知の音バイブレーションの有無が変わる
      importance: Importance.Max,
      // The priority of the notificationポップ通知の有無
      ...
      // Specifies if formatting should be applied to the content and title through HTML markup.
